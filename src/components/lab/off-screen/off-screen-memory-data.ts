...
export const offScreenMemories: MemoryItem[] = [
  { id: "memory-01", role: "hero", src: "/images/off-screen/36.jpg", alt: "Emir smiling beside the Adriatic Sea in Montenegro", location: "Adriatic Sea, Montenegro", date: "2 Aug 2025", caption: ["the best sea I’ve ever swum in"], aspectRatio: 1.333, tone: "mid", desktop: { x: 7, y: 8, width: 43, rotate: -1.2, depth: 70, scale: 1.1, opacity: 0.98 } },
