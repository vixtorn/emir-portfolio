export type MemoryRole = "hero" | "wide" | "portrait" | "observation" | "detail" | "supporting";
...
export type MemoryItem = {
  ...
  aspectRatio: number;
  tone: "light" | "mid" | "dark";
  desktop: { x: number; y: number; width: number; rotate: number; depth: number; scale: number; opacity: number; layer?: number };
};
