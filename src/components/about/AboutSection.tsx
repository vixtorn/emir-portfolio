...
export default function AboutSection() {
  ...
  return (
    <section id="about" className={styles.section} aria-labelledby="about-title" data-disrupted={disrupted} data-reduced-motion={reducedMotion}>
      <header className={styles.header}><p className="type-meta">08 / ABOUT</p></header>
      <div className={styles.desktopComposition}>
        ...
        <div className={`${styles.object} ${styles.foundation}`}>
          <span>COMPUTER ENGINEERING</span><strong>THE FOUNDATION<br />STAYED.</strong><i aria-hidden="true" />
        </div>
        ...
        <div className={styles.storyColumn}>
          <div className={styles.headlineBlock}><h1 id="about-title">ENGINEERING WAS THE START.<br /><em>NOT THE DESTINATION.</em></h1></div>
          <div className={styles.readingCluster}>
            ...
            <div className={styles.emirInside}>
              <Image src="/images/about/emir-inside.gif" alt="Emir Inside" width={1920} height={1080} unoptimized />
            </div>
          </div>
        </div>
